...
export function CatererFilters({
  ...
  return (
    <div className="glass-panel relative z-10 rounded-2xl p-5 space-y-6">
      <div className="grid gap-6 sm:grid-cols-[1fr_auto_1fr_auto_1fr] sm:items-center">
        ...
        <div className="flex flex-col space-y-2 sm:pl-4">
          <label htmlFor="sort" className="text-sm font-semibold text-muted-foreground ml-1">
            Sort By
          </label>
          <select
            id="sort"
            ...
            className="h-11 rounded-xl bg-background/50 px-3 pr-8 shadow-sm border border-border transition-all focus-visible:border-primary focus-visible:ring-0 focus-visible:outline-none text-sm appearance-none bg-no-repeat bg-right"
          >
